...
int main()
{
    ...
    cout << "Kernel Size = 5x5 , Sigma Value = 70.0f\n\n";
    ...
    Mat serial = serialGaussian(src, ksize);
    ...
    Mat cuda = cudaGaussian(src, ksize);
    ...
    hconcat(src, serial, serial);
    hconcat(src, omp, omp);
    hconcat(src, cv, cv);
    hconcat(src, ipp, ipp);
    hconcat(src, cuda, cuda);
